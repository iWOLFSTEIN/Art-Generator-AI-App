...
// void main() {
//   test('Test to compilation time', () async {
//     var calcTime = Stopwatch()..start();

//     var genList = myGenerator().toList();

//     print('Time elapsed is ${calcTime.elapsed.inSeconds}');
//     calcTime.stop();
//   });
// }

// Iterable myGenerator() sync* {
//   int i = 0;
//   while (i < 100000000) {
//     yield i++;
//   }
